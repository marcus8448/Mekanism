...
public class QIOFrequencySelectItemContainer extends FrequencyItemContainer<QIOFrequency> implements IEmptyContainer {
    ...
    public QIOFrequencySelectItemContainer(int id, PlayerInventory inv, PacketByteBuf buf) {
        this(id, inv, buf.readEnumConstant(Hand.class), getStackFromBuffer(buf, Item.class));
    }
