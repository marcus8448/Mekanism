...
public class CommonPlayerTracker {
    ...
    private static final Text ALPHA_WARNING;
    public static boolean monitoringCardboardBox;

    static {
        TranslatableText hereComponent = MekanismLang.ALPHA_WARNING_HERE.translate();
        hereComponent.getStyle().setUnderlined(true).withColor(EnumColor.INDIGO.getColor())
              .withClickEvent(new ClickEvent(Action.OPEN_URL, "https://github.com/mekanism/Mekanism#alpha-status"));
    ...
    public void onPlayerLogoutEvent(PlayerLoggedOutEvent event) {
        Mekanism.playerState.clearPlayer(event.getPlayer().getUuid());
