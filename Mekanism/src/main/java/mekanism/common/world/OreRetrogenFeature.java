...
public class OreRetrogenFeature extends OreFeature {
    ...
    @Override
    public boolean generate(@Nonnull ServerWorldAccess seedReader, @Nonnull StructureAccessor structureManager, @Nonnull ChunkGenerator chunkGenerator, Random rand,
        ...
        for (int l1 = k; l1 <= k + j1; ++l1) {
            for (int i2 = i1; i2 <= i1 + j1; ++i2) {
                ...
                if (l <= seedReader.getTopY(Heightmap.Type.OCEAN_FLOOR, l1, i2)) {
                    return this.generateVeinPart(seedReader, rand, config, xStart, xEnd, zStart, zEnd, yStart, yEnd, k, l, i1, j1, k1);
                }
            }
        }
        return false;
