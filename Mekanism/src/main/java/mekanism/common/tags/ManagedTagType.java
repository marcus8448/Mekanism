...
public final class ManagedTagType<TYPE extends IForgeRegistryEntry<TYPE>> {
    ...
    private final Consumer<TagContainer<TYPE>> collectionSetter;
    private final NonNullLazy<IForgeRegistry<TYPE>> registry;
    private final String type;
    private final String path;

    private ManagedTagType(String type, String path, NonNullLazy<IForgeRegistry<TYPE>> registry, Consumer<TagContainer<TYPE>> collectionSetter) {
        this.type = type;
        this.path = "tags/" + path;
