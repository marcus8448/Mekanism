...
public final class MultipartUtils {
    ...
    public static Pair<Vec3d, Vec3d> getRayTraceVectors(Entity entity) {
        ...
        Vec3d start = new Vec3d(entity.getX(), entity.getY() + entity.getStandingEyeHeight(), entity.getZ());
        ...
        if (entity instanceof ServerPlayerEntity) {
            d3 = ((ServerPlayerEntity) entity).getAttributeInstance(net.minecraftforge.common.ForgeMod.REACH_DISTANCE.get()).getValue();
        }
