...
public class TransporterManager {
     ...
     */
    public static TransitResponse getPredictedInsert(BlockEntity tile, Coord4D position, IItemHandler handler, EnumColor color, TransitRequest request, Direction side) {
    ...
    private static class InventoryInfo {
        ...
        public InventoryInfo(IItemHandler handler) {
            inventory = DefaultedList.ofSize(handler.getSlots(), ItemStack.EMPTY);
