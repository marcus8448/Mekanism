...
public class QIOFrequency extends Frequency {
    ...
    public void tick() {
        ...
        if (!updatedItems.isEmpty() || needsUpdate) {
            ...
            playersViewingItems.removeIf(player -> !(player.currentScreenHandler instanceof QIOItemViewerContainer));
    ...
    public void read(PacketByteBuf buf) {
        ...
        color = buf.readEnumConstant(EnumColor.class);
    }
