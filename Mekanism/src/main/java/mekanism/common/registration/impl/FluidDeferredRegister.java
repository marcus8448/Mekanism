...
public class FluidDeferredRegister {
    ...
    public FluidRegistryObject<Source, Flowing, FluidBlock, BucketItem> registerLiquidChemical(IChemicalConstant constants) {
    ...
    public FluidRegistryObject<Source, Flowing, FluidBlock, BucketItem> register(String name, UnaryOperator<Builder> fluidAttributes) {
    ...
    public FluidRegistryObject<Source, Flowing, FluidBlock, BucketItem> register(String name, FluidAttributes.Builder builder) {
        ...
        FluidRegistryObject<Source, Flowing, FluidBlock, BucketItem> fluidRegistryObject = new FluidRegistryObject<>(modid, name);
        ...
        fluidRegistryObject.updateBucket(itemRegister.register(bucketName, () -> new BucketItem(fluidRegistryObject::getStillFluid,
              ItemDeferredRegister.getMekBaseProperties().maxCount(1).recipeRemainder(Items.BUCKET))));
        ...
        fluidRegistryObject.updateBlock(blockRegister.register(name, () -> new FluidBlock(fluidRegistryObject::getStillFluid,
              Block.Properties.of(Material.WATER).noCollision().strength(100.0F).dropsNothing())));
