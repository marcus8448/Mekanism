...
public class ContainerTypeDeferredRegister extends WrappedDeferredRegister<ScreenHandlerType<?>> {
    ...
    public <CONTAINER extends ScreenHandler> ContainerTypeRegistryObject<CONTAINER> register(INamedEntry nameProvider, IContainerFactory<CONTAINER> factory) {
        return register(nameProvider.getInternalRegistryName(), factory);
    }

    public <CONTAINER extends ScreenHandler> ContainerTypeRegistryObject<CONTAINER> register(String name, IContainerFactory<CONTAINER> factory) {
