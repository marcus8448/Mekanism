...
public class FluidRegistryObject<STILL extends Fluid, FLOWING extends Fluid, BLOCK extends FluidBlock, BUCKET extends BucketItem> implements IFluidProvider {
    ...
    public FluidRegistryObject(String modid, String name) {
        this.stillRO = RegistryObject.of(new Identifier(modid, name), ForgeRegistries.FLUIDS);
        this.flowingRO = RegistryObject.of(new Identifier(modid, "flowing_" + name), ForgeRegistries.FLUIDS);
        this.blockRO = RegistryObject.of(new Identifier(modid, name), ForgeRegistries.BLOCKS);
        this.bucketRO = RegistryObject.of(new Identifier(modid, name + "_bucket"), ForgeRegistries.ITEMS);
    }
