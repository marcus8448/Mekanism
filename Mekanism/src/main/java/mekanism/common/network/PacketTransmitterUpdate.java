...
public class PacketTransmitterUpdate {
    ...
    public static void encode(PacketTransmitterUpdate pkt, PacketByteBuf buf) {
    ...
    public static PacketTransmitterUpdate decode(PacketByteBuf buf) {
        PacketTransmitterUpdate packet = new PacketTransmitterUpdate(buf.readEnumConstant(PacketType.class), buf.readUuid(), buf.readFloat());
