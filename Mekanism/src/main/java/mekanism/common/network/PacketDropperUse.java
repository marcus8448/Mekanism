...
public class PacketDropperUse {
    ...
    public static void encode(PacketDropperUse pkt, PacketByteBuf buf) {
        buf.writeBlockPos(pkt.pos);
        buf.writeEnumConstant(pkt.action);
        buf.writeEnumConstant(pkt.tankType);
        buf.writeVarInt(pkt.tankId);
    }

    public static PacketDropperUse decode(PacketByteBuf buf) {
        return new PacketDropperUse(buf.readBlockPos(), buf.readEnumConstant(DropperAction.class), buf.readEnumConstant(TankType.class), buf.readVarInt());
    }
