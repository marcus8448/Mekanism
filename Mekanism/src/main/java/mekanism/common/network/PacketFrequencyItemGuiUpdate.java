...
public class PacketFrequencyItemGuiUpdate<FREQ extends Frequency> {
    ...
    public static <FREQ extends Frequency> void encode(PacketFrequencyItemGuiUpdate<FREQ> pkt, PacketByteBuf buf) {
    ...
    public static <FREQ extends Frequency> PacketFrequencyItemGuiUpdate<FREQ> decode(PacketByteBuf buf) {
