...
public enum PropertyType {
    ...
    private final BiFunction<Short, PacketByteBuf, PropertyData> dataCreatorFunction;
    ...
    PropertyType(Class<?> type, Object defaultValue, BiFunction<Supplier<Object>, Consumer<Object>, ISyncableData> creatorFunction,
          BiFunction<Short, PacketByteBuf, PropertyData> dataCreatorFunction) {
        this.type = type;
    ...
    public PropertyData createData(short property, PacketByteBuf buffer) {
