...
public class PacketPlayerData {
    ...
    public static void encode(PacketPlayerData pkt, PacketByteBuf buf) {
    ...
    public static PacketPlayerData decode(PacketByteBuf buf) {
        return new PacketPlayerData(buf.readUuid(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean());
    }
}