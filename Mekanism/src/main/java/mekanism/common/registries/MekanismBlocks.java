...
public class MekanismBlocks {
    ...
    public static final BlockRegistryObject<Block, BlockItem> SALT_BLOCK = BLOCKS.register("block_salt", Block.Properties.of(Material.AGGREGATE).strength(0.5F, 0).sounds(BlockSoundGroup.SAND));
