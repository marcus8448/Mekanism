...
public class MultiblockCache<T extends MultiblockData> implements IMekanismInventory, IMekanismFluidHandler, IMekanismStrictEnergyHandler, IMekanismHeatHandler,
    ...
    public enum CacheSubstance {
        ...
        private final Function<Object, List<? extends INBTSerializable<CompoundTag>>> containerList;

        CacheSubstance(String tagKey, Consumer<MultiblockCache<?>> defaultPrefab, Function<Object, List<? extends INBTSerializable<CompoundTag>>> containerList) {
            this.tagKey = tagKey;
        ...
        public List<? extends INBTSerializable<CompoundTag>> getContainerList(Object holder) {
            return containerList.apply(holder);
        }

        public void sync(INBTSerializable<CompoundTag> cache, INBTSerializable<CompoundTag> data) {
            switch (this) {
                case ITEMS:
