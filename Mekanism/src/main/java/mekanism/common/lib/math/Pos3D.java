...
public class Pos3D extends Vec3d {
    ...
    public static Box getAABB(Pos3D pos1, Pos3D pos2) {
        return new Box(pos1.x, pos1.y, pos1.z, pos2.x, pos2.y, pos2.z);
    }
    ...
    public Pos3D translate(Direction direction, double amount) {
        return translate(direction.getVector().getX() * amount, direction.getVector().getY() * amount, direction.getVector().getZ() * amount);
    }
    ...
    @Nonnull
    @Override
    public Pos3D rotateY(float yaw) {
    ...
    @Nonnull
    @Override
    public Pos3D rotateX(float pitch) {
    ...
    @Nonnull
    @Override
    public Pos3D multiply(double scale) {
