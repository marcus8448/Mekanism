...
public class AttributeStateFacing extends AttributeState {
    ...
    public BlockState getStateForPlacement(Block block, @Nullable BlockState state, @Nonnull WorldAccess world, @Nonnull BlockPos pos, @Nullable PlayerEntity player,
