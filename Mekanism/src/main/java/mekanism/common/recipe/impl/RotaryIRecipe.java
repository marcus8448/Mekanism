...
public class RotaryIRecipe extends RotaryRecipe {
    ...
    private RotaryIRecipe(Identifier id, FluidStackIngredient fluidInput, GasStack gasOutput) {
        super(id, fluidInput, gasOutput);
    }

    private RotaryIRecipe(Identifier id, GasStackIngredient gasInput, FluidStack fluidOutput) {
        super(id, gasInput, fluidOutput);
    }

    private RotaryIRecipe(Identifier id, FluidStackIngredient fluidInput, GasStackIngredient gasInput, GasStack gasOutput, FluidStack fluidOutput) {
    ...
    public static class Factory implements RotaryRecipeSerializer.IFactory<RotaryRecipe> {
        ...
        @Override
        public RotaryRecipe create(Identifier id, FluidStackIngredient fluidInput, GasStack gasOutput) {
            return new RotaryIRecipe(id, fluidInput, gasOutput);
        }

        @Override
        public RotaryRecipe create(Identifier id, GasStackIngredient gasInput, FluidStack fluidOutput) {
            return new RotaryIRecipe(id, gasInput, fluidOutput);
        }

        @Override
        public RotaryRecipe create(Identifier id, FluidStackIngredient fluidInput, GasStackIngredient gasInput, GasStack gasOutput, FluidStack fluidOutput) {
