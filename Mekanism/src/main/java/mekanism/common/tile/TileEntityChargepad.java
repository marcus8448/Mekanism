...
public class TileEntityChargepad extends TileEntityMekanism {
    ...
    protected void onUpdateServer() {
        ...
        List<LivingEntity> entities = world.getEntities(LivingEntity.class, new Box(pos.getX(), pos.getY(), pos.getZ(),
    ...
    protected void onUpdateClient() {
        ...
        if (getActive()) {
            world.addParticle(DustParticleEffect.RED, getPos().getX() + world.random.nextDouble(), getPos().getY() + 0.15,
                  getPos().getZ() + world.random.nextDouble(), 0, 0, 0);
        }
    }
