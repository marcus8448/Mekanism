...
public class MekanismJEI implements IModPlugin {
    ...
    private static final Identifier ENERGY_CONVERSION = Mekanism.rl("energy_conversion");
    private static final Identifier GAS_CONVERSION = Mekanism.rl("gas_conversion");
    private static final Identifier INFUSION_CONVERSION = Mekanism.rl("infusion_conversion");
