...
public class ItemStackToGasRecipeCategory extends ItemStackToChemicalRecipeCategory<Gas, GasStack, ItemStackToGasRecipe> {
    ...
    private static final Identifier iconRL = MekanismUtils.getResource(ResourceType.GUI, "gases.png");
    ...
    public ItemStackToGasRecipeCategory(IGuiHelper helper, Identifier id) {
