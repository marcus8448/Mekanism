...
public class ItemStackToInfuseTypeRecipeCategory extends ItemStackToChemicalRecipeCategory<InfuseType, InfusionStack, ItemStackToInfuseTypeRecipe> {
    ...
    private static final Identifier iconRL = MekanismUtils.getResource(ResourceType.GUI, "infuse_types.png");

    public ItemStackToInfuseTypeRecipeCategory(IGuiHelper helper, Identifier id) {
