...
public class ItemStackToEnergyRecipeCategory extends BaseRecipeCategory<ItemStackToEnergyRecipe> {
    ...
    private static final Identifier iconRL = MekanismUtils.getResource(ResourceType.GUI, "energy.png");
    private GuiEnergyGauge gauge;

    public ItemStackToEnergyRecipeCategory(IGuiHelper helper, Identifier id) {
    ...
    @Override
    public List<Text> getTooltipStrings(ItemStackToEnergyRecipe recipe, double mouseX, double mouseY) {
