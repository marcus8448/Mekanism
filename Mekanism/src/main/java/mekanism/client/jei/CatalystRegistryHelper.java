...
public class CatalystRegistryHelper {
    ...
    public static void register(IRecipeCatalystRegistration registry, IBlockProvider mekanismBlock, Identifier... additionalCategories) {
        Identifier[] categories = new Identifier[additionalCategories.length + 1];
    ...
    public static void registerRecipeItem(IRecipeCatalystRegistration registry, IBlockProvider mekanismBlock, Identifier... categories) {
    ...
    public static void registerRecipeItem(IRecipeCatalystRegistration registry, IItemProvider mekanismItem, Identifier... categories) {
