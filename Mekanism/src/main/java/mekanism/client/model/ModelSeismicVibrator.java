...
public class ModelSeismicVibrator extends MekanismJavaModel {
    ...
    private static final Identifier VIBRATOR_TEXTURE = MekanismUtils.getResource(ResourceType.RENDER, "seismic_vibrator.png");
    private final RenderLayer RENDER_TYPE = getLayer(VIBRATOR_TEXTURE);
    ...
    public ModelSeismicVibrator() {
        ...
        plate3.addCuboid(0F, 0F, 0F, 8, 2, 8, false);
        plate3.setPivot(-4F, 22F, -4F);
        plate3.setTextureSize(128, 64);
        plate3.mirror = true;
        setRotation(plate3, 0F, 0F, 0F);
        baseBack = new ExtendedModelRenderer(this, 0, 26);
        baseBack.addCuboid(0F, 0F, 0F, 16, 5, 3, false);
        baseBack.setPivot(-8F, 19F, 5F);
        ...
        motor.addCuboid(0F, 0F, 0F, 6, 4, 10, false);
        motor.setPivot(-3F, -5F, -3F);
        ...
        pole3.addCuboid(0F, 0F, 0F, 1, 25, 1, false);
        pole3.setPivot(6.5F, -6F, -7.5F);
        pole3.setTextureSize(128, 64);
        pole3.mirror = true;
        setRotation(pole3, 0F, 0F, 0F);
        frameRight5 = new ExtendedModelRenderer(this, 4, 34);
        frameRight5.addCuboid(0F, 0F, 0F, 1, 19, 1, false);
        frameRight5.setPivot(6.485F, 7F, -7.5F);
        ...
        baseRight.addCuboid(0F, 0F, 0F, 3, 5, 10, false);
        baseRight.setPivot(5F, 19F, -5F);
        baseRight.setTextureSize(128, 64);
        setRotation(baseRight, 0F, 0F, 0F);
        baseFront = new ExtendedModelRenderer(this, 0, 18);
        baseFront.addCuboid(0F, 0F, 0F, 16, 5, 3, false);
        baseFront.setPivot(-8F, 19F, -8F);
        ...
        baseLeft.addCuboid(0F, 0F, 0F, 3, 5, 10, false);
        baseLeft.setPivot(-8F, 19F, -5F);
        ...
        frameRight3.addCuboid(0F, 0F, 0F, 1, 1, 13, false);
        frameRight3.setPivot(6.5F, 6F, -6.5F);
        ...
        pole1.addCuboid(0F, 0F, 0F, 1, 25, 1, false);
        pole1.setPivot(-7.5F, -6F, -7.5F);
        pole1.setTextureSize(128, 64);
        pole1.mirror = true;
        setRotation(pole1, 0F, 0F, 0F);
        frameRight4 = new ExtendedModelRenderer(this, 4, 34);
        frameRight4.addCuboid(0F, 0F, -1F, 1, 19, 1, false);
        frameRight4.setPivot(6.49F, 7F, 7.5F);
        ...
        frameRight1.addCuboid(0F, 0F, 0F, 1, 19, 1, false);
        frameRight1.setPivot(6.485F, -6F, -7.5F);
        ...
        frameRight2.addCuboid(0F, 0F, -1F, 1, 19, 1, false);
        frameRight2.setPivot(6.49F, -6F, 7.5F);
        ...
        frameLeft5.addCuboid(0F, 0F, 0F, 1, 19, 1, false);
        frameLeft5.setPivot(-7.485F, 7F, -7.5F);
        ...
        frameLeft4.addCuboid(0F, 0F, -1F, 1, 19, 1, false);
        frameLeft4.setPivot(-7.49F, 7F, 7.5F);
        ...
        frameBack3.addCuboid(0F, 0F, 0F, 13, 1, 1, false);
        frameBack3.setPivot(-6.5F, 6F, 6.5F);
        ...
        frameLeft2.addCuboid(0F, 0F, 0F, 1, 19, 1, false);
        frameLeft2.setPivot(-7.485F, -6F, -7.5F);
        ...
        frameLeft1.addCuboid(0F, 0F, -1F, 1, 19, 1, false);
        frameLeft1.setPivot(-7.49F, -6F, 7.5F);
        ...
        pole2.addCuboid(0F, 0F, 0F, 1, 25, 1, false);
        pole2.setPivot(-7.5F, -6F, 6.5F);
        pole2.setTextureSize(128, 64);
        pole2.mirror = true;
        setRotation(pole2, 0F, 0F, 0F);
        frameBack1 = new ExtendedModelRenderer(this, 4, 34);
        frameBack1.addCuboid(-1F, 0F, 0F, 1, 19, 1, false);
        frameBack1.setPivot(7.5F, -6F, 6.49F);
        ...
        frameBack2.addCuboid(0F, 0F, 0F, 1, 19, 1, false);
        frameBack2.setPivot(-7.5F, -6F, 6.49F);
        ...
        frameBack4.addCuboid(0F, 0F, 0F, 1, 19, 1, false);
        frameBack4.setPivot(-7.5F, 7F, 6.49F);
        ...
        frameLeft3.addCuboid(0F, 0F, 0F, 1, 1, 13, false);
        frameLeft3.setPivot(-7.5F, 6F, -6.5F);
    ...
    public void renderWireFrame(MatrixStack matrix, VertexConsumer vertexBuilder, float piston, float red, float green, float blue, float alpha) {
        shaft1.pivotY = 6 - (piston * 12);
        plate2.pivotY = 21 - (piston * 12);
        plate3.pivotY = 22 - (piston * 12);
