...
public class RenderFluidTankItem extends BuiltinModelItemRenderer {
    ...
    @Override
    public void render(@Nonnull ItemStack stack, @Nonnull Mode transformType, @Nonnull MatrixStack matrix, @Nonnull VertexConsumerProvider renderer,
        ...
        if (!fluid.isEmpty()) {
            ...
            if (fluidScale > 0) {
                ...
                MekanismRenderer.renderObject(getFluidModel(fluid, modelNumber), matrix, renderer.getBuffer(TexturedRenderLayers.getEntityTranslucentCull()),
        ...
        modelFluidTank.render(matrix, renderer, light, overlayLight, tier, stack.hasGlint());
        matrix.pop();
    }
