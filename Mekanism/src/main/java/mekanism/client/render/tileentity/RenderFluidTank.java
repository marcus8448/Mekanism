...
public class RenderFluidTank extends MekanismTileEntityRenderer<TileEntityFluidTank> {
    ...
    public RenderFluidTank(BlockEntityRenderDispatcher renderer) {
        super(renderer);
    }
    ...
    @Override
    protected void render(TileEntityFluidTank tile, float partialTick, MatrixStack matrix, VertexConsumerProvider renderer, int light, int overlayLight, Profiler profiler) {
