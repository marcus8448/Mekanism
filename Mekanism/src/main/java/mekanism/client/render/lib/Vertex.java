...
public class Vertex {
    ...
    public static Vertex create(Vec3d pos, Vec3d normal, Color color, Sprite sprite, float texU, float texV, float lightU, float lightV) {
        return new Vertex(pos, normal, color, sprite.getFrameU(texU), sprite.getFrameV(texV), lightU, lightV);
    }

    public static Vertex create(Vec3d pos, Vec3d normal, Sprite sprite, float u, float v) {
