...
public abstract class GuiQIOItemViewer<CONTAINER extends QIOItemViewerContainer> extends GuiMekanism<CONTAINER> {
    ...
    public void init() {
        ...
        addButton(new GuiResizeControls(this, (getMinecraft().getWindow().getScaledHeight() / 2) - 20 - getGuiTop(), this::resize));
    }
    ...
    private void recreateViewer() {
        ...
        getMinecraft().player.currentScreenHandler = ((ScreenHandlerProvider<?>) s).getScreenHandler();
        getMinecraft().openScreen(s);
