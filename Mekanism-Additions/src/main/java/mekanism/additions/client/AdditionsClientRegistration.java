...
public class AdditionsClientRegistration {
    ...
    public static void init(FMLClientSetupEvent event) {
        ...
        ClientRegistrationUtil.registerEntityRenderingHandler(AdditionsEntityTypes.BABY_SKELETON, SkeletonEntityRenderer::new);
        ClientRegistrationUtil.registerEntityRenderingHandler(AdditionsEntityTypes.BABY_STRAY, StrayEntityRenderer::new);
        ClientRegistrationUtil.registerEntityRenderingHandler(AdditionsEntityTypes.BABY_WITHER_SKELETON, WitherSkeletonEntityRenderer::new);

        ClientRegistrationUtil.setRenderLayer(RenderLayer.getTranslucent(),
