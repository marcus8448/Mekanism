...
public class EntityBabyEnderman extends EndermanEntity {
    ...
    private static final TrackedData<Boolean> IS_CHILD = DataTracker.registerData(EntityBabyEnderman.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    protected float getActiveEyeHeight(@Nonnull EntityPose pose, @Nonnull EntityDimensions size) {
        return this.isBaby() ? 1.36F : super.getActiveEyeHeight(pose, size);
    }
