...
public class MekanismAdditions implements IModule {
    ...
    public static final EntityAttributeModifier babySpeedBoostModifier = new EntityAttributeModifier(babySpeedBoostUUID, "Baby speed boost", 0.5D, Operation.MULTIPLY_BASE);
    ...
    private void commonSetup(FMLCommonSetupEvent event) {
        ...
        DeferredWorkQueue.runLater(() -> {
            ...
            ParrotEntity.MOB_SOUNDS.put(AdditionsEntityTypes.BABY_CREEPER.getEntityType(), SoundEvents.ENTITY_PARROT_IMITATE_CREEPER);
            ParrotEntity.MOB_SOUNDS.put(AdditionsEntityTypes.BABY_SKELETON.getEntityType(), SoundEvents.ENTITY_PARROT_IMITATE_SKELETON);
            ParrotEntity.MOB_SOUNDS.put(AdditionsEntityTypes.BABY_STRAY.getEntityType(), SoundEvents.ENTITY_PARROT_IMITATE_STRAY);
            ParrotEntity.MOB_SOUNDS.put(AdditionsEntityTypes.BABY_WITHER_SKELETON.getEntityType(), SoundEvents.ENTITY_PARROT_IMITATE_WITHER_SKELETON);
        });
    ...
    private static void registerSpawnEggDelayed(ItemRegistryObject<AdditionsSpawnEggItem>... spawnEggs) {
        ItemDispenserBehavior dispenseBehavior = new ItemDispenserBehavior() {
            ...
            public ItemStack dispenseSilently(BlockPointer source, ItemStack stack) {
                ...
                entityType.spawnFromItemStack(source.getWorld(), stack, null, source.getBlockPos().offset(direction), SpawnReason.DISPENSER, direction != Direction.UP, false);
                stack.decrement(1);
                return stack;
            }
        };
