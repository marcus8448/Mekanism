...
public class ItemStackToChemicalRecipeBuilder<CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>> extends
    ...
    protected ItemStackToChemicalRecipeBuilder(Identifier serializerName, ItemStackIngredient input, STACK output,
    ...
    @Override
    protected ItemStackToChemicalRecipeResult getResult(Identifier id) {
        return new ItemStackToChemicalRecipeResult(id);
    }

    public class ItemStackToChemicalRecipeResult extends RecipeResult {

        protected ItemStackToChemicalRecipeResult(Identifier id) {
            super(id);
        }
