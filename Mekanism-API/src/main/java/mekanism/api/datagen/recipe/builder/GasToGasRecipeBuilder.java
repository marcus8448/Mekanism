...
public class GasToGasRecipeBuilder extends MekanismRecipeBuilder<GasToGasRecipeBuilder> {
    ...
    protected GasToGasRecipeBuilder(GasStackIngredient input, GasStack output, Identifier serializerName) {
    ...
    @Override
    protected GasToGasRecipeResult getResult(Identifier id) {
        return new GasToGasRecipeResult(id);
    }

    public class GasToGasRecipeResult extends RecipeResult {

        protected GasToGasRecipeResult(Identifier id) {
            super(id);
        }
