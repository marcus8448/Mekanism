...
public class GeneratorsClientRegistration {
    ...
    public static void init(FMLClientSetupEvent event) {
        ...
        //Block render layers
        ClientRegistrationUtil.setRenderLayer(RenderLayer.getTranslucent(), GeneratorsBlocks.LASER_FOCUS_MATRIX, GeneratorsBlocks.REACTOR_GLASS);
        ...
        ClientRegistration.addCustomModel(GeneratorsBlocks.ADVANCED_SOLAR_GENERATOR, (orig, evt) -> new TransformedBakedModel<Void>(orig,
              QuadTransformation.translate(new Vec3d(0, 1, 0))));
    }
    ...
    public static void registerContainers(RegistryEvent.Register<ScreenHandlerType<?>> event) {
        ...
        ClientRegistrationUtil.registerScreen(GeneratorsContainerTypes.SOLAR_GENERATOR, (MekanismTileContainer<TileEntitySolarGenerator> container, PlayerInventory inv, Text title) -> new GuiSolarGenerator<>(container, inv, title));
        ClientRegistrationUtil.registerScreen(GeneratorsContainerTypes.ADVANCED_SOLAR_GENERATOR, (MekanismTileContainer<TileEntityAdvancedSolarGenerator> container, PlayerInventory inv, Text title) -> new GuiSolarGenerator<>(container, inv, title));
