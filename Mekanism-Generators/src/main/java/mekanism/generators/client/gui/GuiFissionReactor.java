...
public class GuiFissionReactor extends GuiMekanismTile<TileEntityFissionReactorCasing, EmptyTileContainer<TileEntityFissionReactorCasing>> {
    ...
    public GuiFissionReactor(EmptyTileContainer<TileEntityFissionReactorCasing> container, PlayerInventory inv, Text title) {
    ...
    public void init() {
        ...
        addButton(new GuiHeatTab(() -> {
            Text environment = MekanismUtils.getTemperatureDisplay(tile.getMultiblock().lastEnvironmentLoss, TemperatureUnit.KELVIN, false);
        ...
        }, 5, 104, backgroundWidth - 12));
        addButton(heatGraph = new GuiGraph(this, 6, 128, backgroundWidth - 12, 36, MekanismLang.TEMPERATURE::translate));
