...
public class GuiTurbineStats extends GuiMekanismTile<TileEntityTurbineCasing, EmptyTileContainer<TileEntityTurbineCasing>> {
    ...
    public GuiTurbineStats(EmptyTileContainer<TileEntityTurbineCasing> container, PlayerInventory inv, Text title) {
    ...
    protected void drawForegroundText(@Nonnull MatrixStack matrix, int mouseX, int mouseY) {
        ...
        if (tile.getMultiblock().isFormed()) {
            Text limiting = GeneratorsLang.IS_LIMITING.translateColored(EnumColor.DARK_RED);
