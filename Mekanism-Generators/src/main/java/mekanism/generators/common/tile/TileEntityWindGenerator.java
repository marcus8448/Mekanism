...
public class TileEntityWindGenerator extends TileEntityGenerator implements IBoundingBlock {
    ...
    public void onLoad() {
        ...
        if (world != null) {
            ...
            isBlacklistDimension = MekanismGeneratorsConfig.generators.windGenerationDimBlacklist.get().contains(world.getRegistryKey().getValue());
    ...
    private FloatingLong getMultiplier() {
        if (world != null && world.isSkyVisibleAllowingSea(getPos().up(4))) {
    ...
    public Box getRenderBoundingBox() {
        ...
        return new Box(pos.add(-2, 0, -2), pos.add(3, 7, 3));
    }
}