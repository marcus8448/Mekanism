...
public class TileEntitySolarGenerator extends TileEntityGenerator {
    ...
    protected void recheckSettings() {
        ...
        Biome b = world.getBiomeAccess().getBiome(getPos());
        ...
        float humidityEff = -0.3F * (needsRainCheck ? b.getRainfall() : 0.0F);
    ...
    protected void onUpdateServer() {
        ...
        World world = getWorld();
        if (world != null) {
            seesSun = world.isDay() && canSeeSky() && world.getDimension().hasSkyLight();
        }
    ...
    protected boolean canSeeSky() {
        World world = getWorld();
        return world != null && world.isSkyVisibleAllowingSea(getPos());
    }
