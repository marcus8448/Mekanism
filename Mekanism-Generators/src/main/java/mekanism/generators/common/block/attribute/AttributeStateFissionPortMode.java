...
public class AttributeStateFissionPortMode extends AttributeState {
    ...
    public static final EnumProperty<FissionPortMode> modeProperty = EnumProperty.of("mode", FissionPortMode.class);
    ...
    public enum FissionPortMode implements StringIdentifiable, IHasTextComponent, IIncrementalEnum<FissionPortMode> {
